...
import { register, confirmEmail, logIn, forgetPassword, continueWithGoogle } from './auth.controller.js'
...
router.post('/cont-with-gmail', asyncHandler(continueWithGoogle))
